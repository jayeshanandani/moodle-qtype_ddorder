...
/**
 * ddorder question renderer class.
 *
...
class qtype_ddorder_renderer extends qtype_with_combined_feedback_renderer {
    ...
    private function construct_ablock_select(question_attempt $qa,
        ...
        foreach ($stemorder as $key => $stemid) {
            ...
            $o .= html_writer::tag('td', $question->format_text(
                    ...
                    $qa, 'qtype_ddorder_options', 'subquestion', $stemid),
                    array('class' => 'text'));
    ...
    private function construct_ablock_dragable(question_attempt $qa,
        ...
        $o .= ' '.get_string('defaultresponse', 'qtype_ddorder_options');
        ...
        if (count($choices)) {
            ...
            foreach ($choices as $key => $subqid) {
                $table->data[][] = $question->format_text($question->stems[$subqid],
                        ...
                        'qtype_ddorder_options', 'subquestion', $subqid);
            }
